...
font_tick = 25
fig, ((axs0, axs1), (axs2, axs3), (axs4, axs5)) = plt.subplots(3, 2, figsize = (20, 18), sharey = True)
...
plt.tight_layout()
plt.savefig('./manuscript_figures/phdtalk_tqc_compare_artmistral_nwp_leeds_no_legend.png')
plt.savefig('./manuscript_figures/phdtalk_tqc_compare_artmistral_nwp_leeds_no_legend.pdf')
plt.show()
