...
ncout = Dataset(
    '/work/bb1036/b380900/work_levante/cosp_var_new_version_icon/holo_cosp_runs_nwp_10kmremap/7_sep_per.nc',
    mode = "w", format = 'NETCDF4_CLASSIC')

ipath = '/work/bb1093/b380900/compare_nwp_art/perturbed_holo_nwp/'
fileList = open(
    '/work/bb1093/b380900/compare_nwp_art/perturbed_holo_nwp/diff_timestep_file_list_7_sep.txt', 'r+')
