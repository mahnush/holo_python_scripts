...
icon_output_names_1sep = 'selvar_NWP_LAM_DOM01_20140901T100000Z_0010.nc'
...
icon_output_names_1sep_per = 'selvar_NWP_LAM_DOM02_20140901T100000Z_0009.nc'
...
var_name_model = ['nd_dw', 'modis_Liquid_Water_Path_Mean', 'tau_dw', 're_dw']
...
def get_in_out(i):
    ...
    control_var_lando = postpro_func.read_nc(model_con[i], var_name_model[1])[0, :, :]*1e3
    control_var_lando = control_var_lando[50:1551, 50:4051]
    perturbed_var_lando = postpro_func.read_nc(model_per[i], var_name_model[1])[0, :, :]*1e3
