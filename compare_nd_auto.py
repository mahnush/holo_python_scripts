...
def pdf_var_prepare(axs0, var, color, label, titel, x_axis_label = '', y_axis_label = ''):
    ...
    axs0.hist(var,  bins=numbin, weights=weight(var),  histtype='step',
         linewidth=line_width, color= color, label= label + lable_hist(var))
...
#plt.tight_layout()
plt.savefig('nd_auto_conversion_test_2sep.png')
plt.savefig('nd_auto_conversion_test_2sep.pdf')
plt.show()
...
#plt.tight_layout()
plt.savefig('nd_auto_conversion_test_3sep.png')
plt.savefig('nd_auto_conversion_test_3sep.pdf')
plt.show()
...
#plt.tight_layout()
plt.savefig('nd_auto_conversion_test_all.png')
plt.savefig('nd_auto_conversion_test_all.pdf')
plt.show()