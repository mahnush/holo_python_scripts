...
fig, ((axs0, axs1), (axs2, axs3), (axs4, axs5), (axs6, axs7)) = \
    plt.subplots(4, 2, figsize = (16, 18), sharey = True)
font_tick = 20
...
pdf_var_prepare(axs6, var = allvar_in_con_cosp, range = range_nwp, color = 'blue', label = run_type[0],
                titel = 'Inside_Plume ' + titel_kind[3])
pdf_var_prepare(axs6, var = allvar_in_per_cosp, range = range_nwp, color = 'red', label = run_type[1],
                titel = 'Inside_Plume ' + titel_kind[3])
pdf_var_prepare(axs6, var = allvar_in_modis, range = range_nwp, color = 'black', label = run_type[2],
                titel = 'Inside_Plume ' + titel_kind[3], y_axis_label = y_name, x_axis_label = x_name)


pdf_var_prepare(axs7, var = allvar_out_con_cosp, range = range_nwp, color = 'blue', label = run_type[0],
                titel = 'Outside_Plume ' + titel_kind[3])
pdf_var_prepare(axs7, var = allvar_out_per_cosp, range = range_nwp, color = 'red', label = run_type[1],
                titel = 'Outside_Plume ' + titel_kind[3], x_axis_label = x_name, y_axis_label = y_name)
pdf_var_prepare(axs7, var = allvar_out_modis, range = range_nwp, color = 'black', label = run_type[2],
                titel = 'Outside_Plume ' + titel_kind[3], x_axis_label = x_name)

axs6.annotate("(g)", xy=(0.07, 0.93), xycoords="axes fraction", fontsize= font_tick)
axs7.annotate("(h)", xy=(0.07, 0.93), xycoords="axes fraction", fontsize= font_tick)
plt.tight_layout()
...
"""
create the plot without the ART part
"""
range_nwp = (0, 3e8)
range_um = (0, 3e8)
...
pdf_var_prepare(axs2, var = allvar_in_con_um, range = range_um, color = 'blue', label = run_type[0],
               titel = 'Inside_Plume ' + titel_kind[2])
pdf_var_prepare(axs2, var = allvar_in_per_um, range = range_um, color = 'red', label = run_type[1],
               titel = 'Inside_Plume ' + titel_kind[2], y_axis_label = y_name, x_axis_label = x_name)
pdf_var_prepare(axs2, var = allvar_in_modis, range = range_nwp, color = 'black', label = run_type[2],
                titel = 'Inside_Plume ' + titel_kind[2], y_axis_label = y_name)
axs2.annotate("(c)", xy=(0.07, 0.93), xycoords="axes fraction", fontsize= font_tick)

pdf_var_prepare(axs3, var = allvar_out_con_um, range = range_um, color = 'blue', label = run_type[0],
               titel = 'Outside_Plume ' + titel_kind[2])
pdf_var_prepare(axs3, var = allvar_out_per_um, range = range_um, color = 'red', label = run_type[1],
               titel = 'Outside_Plume ' + titel_kind[2], x_axis_label = x_name)
pdf_var_prepare(axs3, var = allvar_out_modis, range = range_nwp, color = 'black', label = run_type[2],
                titel = 'Outside_Plume ' + titel_kind[2])
axs3.annotate("(d)", xy=(0.07, 0.93), xycoords="axes fraction", fontsize= font_tick)
...
pdf_var_prepare(axs4, var = allvar_in_con_cosp, range = range_nwp, color = 'blue', label = run_type[0],
                titel = 'Inside_Plume ' + titel_kind[3])
pdf_var_prepare(axs4, var = allvar_in_per_cosp, range = range_nwp, color = 'red', label = run_type[1],
                titel = 'Inside_Plume ' + titel_kind[3])
pdf_var_prepare(axs4, var = allvar_in_modis, range = range_nwp, color = 'black', label = run_type[2],
                titel = 'Inside_Plume ' + titel_kind[3], y_axis_label = y_name, x_axis_label = x_name)
axs4.annotate("(e)", xy=(0.07, 0.93), xycoords="axes fraction", fontsize= font_tick)

pdf_var_prepare(axs5, var = allvar_out_con_cosp, range = range_nwp, color = 'blue', label = run_type[0],
                titel = 'Outside_Plume ' + titel_kind[3])
pdf_var_prepare(axs5, var = allvar_out_per_cosp, range = range_nwp, color = 'red', label = run_type[1],
                titel = 'Outside_Plume ' + titel_kind[3], x_axis_label = x_name, y_axis_label = y_name)
pdf_var_prepare(axs5, var = allvar_out_modis, range = range_nwp, color = 'black', label = run_type[2],
                titel = 'Outside_Plume ' + titel_kind[3], x_axis_label = x_name)
axs5.annotate("(f)", xy=(0.07, 0.93), xycoords="axes fraction", fontsize= font_tick)
...
plt.tight_layout()
plt.savefig('./manuscript_figures/qnc_total_column_nwp_leeds_cosp_modis_with_legends_6days.png')
plt.savefig('./manuscript_figures/qnc_total_column_nwp_leeds_cosp_modis_with_legends_6days.pdf')
plt.show()
